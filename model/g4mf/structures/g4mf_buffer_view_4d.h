...
public:
	...
	static int write_new_buffer_view_into_state(const Ref<G4MFState4D> &p_g4mf_state, const PackedByteArray &p_input_data, const bool p_deduplicate = true, const int p_buffer_index = 0);
