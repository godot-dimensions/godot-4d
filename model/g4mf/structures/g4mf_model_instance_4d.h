...
public:
	...
	int get_model_file_index() const { return _model_file_index; }
	void set_model_file_index(const int p_model_file_index) { _model_file_index = p_model_file_index; }
