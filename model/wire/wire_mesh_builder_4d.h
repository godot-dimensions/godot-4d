...
public:
	static Ref<ArrayWireMesh4D> make_3d_orthoplex_sphere(const real_t p_radius, const int p_subdivisions, const real_t p_cone_tip_position = 0.0);
	static Ref<ArrayWireMesh4D> make_3d_subdivided_box(const Vector3 &p_size, const Vector3i &p_subdivision_segments, const bool p_fill_cell = false, const bool p_breakup_edges = false);
