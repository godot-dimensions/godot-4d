...
PackedVector4Array BoxTetraMesh4D::get_cell_face_normals() {
	return _tetra_decomp == BOX_TETRA_DECOMP_40_CELL ? BOX_40_CELL_FACE_NORMALS : BOX_48_CELL_FACE_NORMALS;
}
