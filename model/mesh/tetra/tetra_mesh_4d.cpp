...
void TetraMesh4D::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("raycast_intersects_fast", "local_from", "local_direction", "max_distance"), &TetraMesh4D::raycast_intersects_fast, DEFVAL(3.4e38));
	ClassDB::bind_method(D_METHOD("raycast_intersects", "local_from", "local_direction", "max_distance"), &TetraMesh4D::raycast_intersects, DEFVAL(3.4e38));
