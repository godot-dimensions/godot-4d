...
class EditorImportPluginHoxPoly4D : public EditorImportPluginHoxBase4D {
	GDCLASS(EditorImportPluginHoxPoly4D, EditorImportPluginHoxBase4D);
...
public:
	...
	virtual float GDEXTMOD_GET_PRIORITY() const override { return 8.0f; }
#if GDEXTENSION
