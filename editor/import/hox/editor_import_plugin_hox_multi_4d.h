...
#include "editor_import_plugin_hox_base_4d.h"

class ArrayPolyMesh4D;

class EditorImportPluginHoxMulti4D : public EditorImportPluginHoxBase4D {
	GDCLASS(EditorImportPluginHoxMulti4D, EditorImportPluginHoxBase4D);
