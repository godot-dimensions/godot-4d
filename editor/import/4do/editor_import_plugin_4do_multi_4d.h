...
#include "editor_import_plugin_4do_base_4d.h"

class ArrayPolyMesh4D;

class EditorImportPlugin4DOMulti4D : public EditorImportPlugin4DOBase4D {
	GDCLASS(EditorImportPlugin4DOMulti4D, EditorImportPlugin4DOBase4D);
...
public:
	...
	virtual float GDEXTMOD_GET_PRIORITY() const override { return 10.0f; }
#if GDEXTENSION
