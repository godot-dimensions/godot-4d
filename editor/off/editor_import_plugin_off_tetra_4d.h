...
class EditorImportPluginOFFTetra4D : public EditorImportPluginOFFBase {
	GDCLASS(EditorImportPluginOFFTetra4D, EditorImportPluginOFFBase);
...
public:
	...
	virtual double _get_priority() const override { return 4.0f; }
	...
	virtual float get_priority() const override { return 4.0f; }
