...
constexpr int32_t VOXEL_DATA_CHUNK_SIZE = 8;
...
// The mesh handler currently assumes this is true.
static_assert(VOXEL_MESH_CHUNK_SIZE % VOXEL_DATA_CHUNK_SIZE == 0, "Mesh chunks must cover a whole number of data chunks.");
